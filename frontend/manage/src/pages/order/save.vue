              ...
              <table>
                ...
                <tr>
                  <td>
                    ...
                    <span v-text="form.address.name"></span>
                  </td>
                  <td>
                    <span v-text="form.address.phone"></span>
                ...
                <tr>
                  <td>
                    ...
                    <span v-text="form.address.province"></span>
                  </td>
                </tr>
                </tbody>
              </table>
    ...
    methods: {
      ...
      on_submit_form(){
        this.$refs.form.validate((valid) => {
          ...
          this.$fetch.order.save(this.route_id, this.form)
            .then(({msg}) => {
